...
你要的“尽量全地搜集”在实践上必须先设定边界：目前已确认的系外行星超过数千颗，若不设筛选标准就会沦为“清单堆砌”。我这里按“显著特征 + 高研究价值”的常用学术口径，优先覆盖以下几类：**（i）方法学里程碑**（首次/典型：首颗热木星、首批凌日、首次大气元素/分子）、**（ii）可居住带与近邻**（最近恒星、M矮星可居住带系统、最适合大气表征的候选）、**（iii）大气化学与气候极端**（JWST/HST/地面高分辨率揭示的关键分子、极端温度/反照率/质量损失）、**（iv）体系结构与形成**（共振链、多行星紧致系统、双星绕转、直接成像的年轻巨行星、原行星/卫星形成现场）。下表先给“基本数据与事实”，随后给一篇尽量连贯的综合综述（把信息组织成可用的研究地图，而不是碎片化条目）。

---

## 1) 基本数据与事实表（精选：里程碑/可表征/极端/形成现场）

说明：表中质量、半径、温度等参数会随后续观测与联合拟合更新；我尽量使用权威目录页/机构发布作为锚点。对“里程碑事件/关键发现（例如某分子被JWST检测）”也给出对应来源。

| 行星（系统）                          |       距离（约） | 发现/确认（年）与方法          | 类型（粗分）          |     轨道周期 | 代表性“显著特征/研究价值”                                               | 关键来源                                                                                     |
| ------------------------------- | ----------: | -------------------- | --------------- | -------: | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| **51 Pegasi b（Dimidium）**       |      ~50 ly | 1995，径向速度            | 热木星             |   ~4.2 d | **首个绕类太阳主序星的系外行星**；奠定RV时代与“热木星”范式                            | NASA目录页 ([NASA Science][1])；NASA方法综述 ([NASA Science][2])                                 |
| **HD 209458 b（Osiris）**         |     ~150 ly | 1999，RV/凌日           | 热木星             |   ~3.5 d | 早期“凌日样本”标杆；**HST对其大气钠与逃逸证据**成为大气表征里程碑                        | NASA目录页 ([NASA Science][3])；ESA/Hubble年表 ([Hubble Space Telescope][4])                   |
| **WASP-96 b**                   |           — | 凌日（已知多年；JWST 2022表征） | 热气巨行星           |        — | **JWST首批高精度透射谱**：水汽、云/雾霾证据，展示JWST对大气的“能力上限”                  | NASA发布 ([NASA Science][5])                                                               |
| **WASP-39 b**                   |           — | 凌日                   | 热土星/热木星         |        — | **JWST揭示前所未有细节的大气化学**（包括光化学相关信号），成为“系外行星化学实验室”               | NASA发布 ([NASA Science][6])                                                               |
| **K2-18 b**                     | ~120–124 ly | 2015后确认，凌日/RV        | 亚海王星/可能“Hycean” |    ~33 d | 位于可居住带；**JWST检测到甲烷与二氧化碳**，并在后续研究中引发关于潜在生物信号（如DMS/DMDS）的高强度讨论 | NASA（2023）([NASA Science][7])；路透（2025-04-16）([Reuters][8])                               |
| **TRAPPIST-1 e（及TRAPPIST-1系统）** |      ~39 ly | 2016–2017，凌日         | 岩质（多颗）          | e：~6.1 d | **7颗近地大小岩质行星的共振链**；可居住带候选（e/f/g）；JWST持续做大气边界条件测试             | NASA系统概览 ([NASA Exoplanet Archive][9])；NASA 2025进展页 ([NASA Science][10])                 |
| **Proxima Centauri b**          |     4.24 ly | 2016，径向速度            | 超级地球            |  ~11.2 d | **距离最近的潜在岩质候选**；也是“恒星活动/耀斑环境下可居住性”最关键天然实验场之一                 | NASA目录页 ([NASA Science][11])                                                             |
| **TOI-700 e**                   |     ~100 ly | 2023，凌日（TESS）        | 近地大小（可能岩质）      |        — | M矮星可居住带内的近地大小世界；与同系统的TOI-700 d共同构成“可居住带对照组”                  | JPL发布 ([NASA Jet Propulsion Laboratory (JPL)][12])                                       |
| **TOI-270 d**                   |      ~70 ly | 凌日（TESS）             | 超级地球/小海王星       |        — | JWST大气结果引出“水世界/超临界流体”之争；是理解“富氢包层+水相态”的关键样本                   | Guardian概述（争议并存）([The Guardian][13])                                                     |
| **KELT-9 b**                    |     ~650 ly | 2017，凌日              | 超热木星            |   ~1.5 d | **已知最极端高温行星之一**（平衡温度量级可达~4000 K）；用于检验高温化学、解离/电离、风场与逃逸        | A&A综述式论文提及其极端温度 ([A&A][14])                                                              |
| **HD 189733 b**                 |    ~64.5 ly | 2005，凌日              | 热木星             |   ~2.2 d | 经典“大气天气学”样本：**强风与“可能的玻璃侧向降雨”**的公众化表述源自NASA科普；也是相位曲线/温度图先驱案例  | NASA图文（2016）([NASA][15])                                                                 |
| **TrES-2 b（Kepler-1b）**         |     ~750 ly | 2006/确认，凌日           | 热木星             |        — | **极低反照率（“最黑”之一）**：反照率测量推动云/吸收剂模型与能量收支讨论                      | NASA目录页 ([NASA Science][16])；NatGeo报道（2011）([National Geographic][17])                   |
| **WASP-76 b**                   |     ~390 ly | 凌日                   | 超热木星            |        — | 高分辨率光谱与昼夜侧差异的经典：**“铁雨”**叙事来自对凝结/输运的推断与观测约束                   | nccr-planets/UNIGE解读 ([nccr-planets.ch][18])                                             |
| **WASP-12 b**                   |    ~1400 ly | 凌日                   | 超热木星            |   ~1.1 d | **潮汐形变与质量损失/轨道衰减**：把“行星死亡”从理论推到可观测层面                         | Nature 2010（ADS摘要）([ui.adsabs.harvard.edu][19])；arXiv版本 ([arxiv.org][20])                |
| **HR 8799 b/c/d/e（系统）**         |     ~129 ly | 2008起，直接成像           | 年轻巨行星           |        — | **多行星直接成像标杆系统**：用于检验巨行星冷/热启动、云与谱线反演、长期动力学稳定性                 | Science 2008（ADS）([ui.adsabs.harvard.edu][21])；NASA解读 ([NASA Science][22])               |
| **PDS 70 b/c（系统）**              |     ~370 ly | 2018起，直接成像           | 原行星（形成中）        |        — | **行星形成现场**：缝隙内原行星、吸积证据与（疑似）环行星盘，连接“盘—行星—卫星”链条                | ApJ Letters 2021（ADS）([ui.adsabs.harvard.edu][23])；ALMA新闻稿（2025）([ALMA Observatory][24]) |

这张表刻意把“每颗行星的研究意义”放在与“基本参数”同一行：原因很简单——对高价值样本而言，**参数本身不是目的，参数是进入某一类物理问题的门票**。下面的综述就按“问题域”把这些门票组织成一张可操作的地图。

---

## 2) 综述：这些“显著特征”系外行星，究竟在研究上各自承担什么角色？

### 2.1 从“发现”到“可表征”：方法学里程碑如何塑造问题边界

系外行星科学最重要的一条主线，是从“有没有”走向“是什么”。**51 Pegasi b**的意义不在于它是热木星（我们后来见过很多），而在于它用径向速度（RV）把“绕类太阳恒星的行星”从哲学猜想变成统计学对象：一旦RV能稳定检出周期为数天、质量为木星量级的伴星，天文学家立刻意识到行星系统的结构可能与太阳系截然不同——“迁移”（migration）不再是边缘理论，而成了解释热木星的核心机制。NASA对RV方法的回顾也明确把1995年那次发现视为关键拐点：热木星对恒星的“拉扯”足够大，从而让RV在当时的仪器条件下成为突破口。([NASA Science][2])

紧接着，**HD 209458 b**把“几何凌日”变成可重复、可扩展的观测通道：凌日不仅给半径，还把大气变成可以通过透射谱读取的对象。早期HST对其大气钠以及后续对高层大气逃逸的证据，被ESA/Hubble的时间线式总结明确列为该系统的标志性成果。([Hubble Space Telescope][4]) 这一步的范式转变是：我们不再只问$$M,R,P$$，而开始问“成分、云、光化学、能量收支、逃逸速率”。换句话说，**系外行星开始进入“行星科学”而不仅是“天体测量学”**。

JWST把这条线推到新的分辨率与信噪比。以**WASP-96 b**为例，NASA把它明确描述为JWST首批透射谱中展示水汽与云霾证据的代表，并强调其波段覆盖与精度使之成为能力展示。([NASA Science][5]) 而**WASP-39 b**则更像“化学与光化学的实验台”：当你能在更宽波段、更高精度下解析谱结构，讨论就从“是否有水”推进到“金属丰度、C/O比、光化学生成物、垂直混合与温度结构的耦合”。([NASA Science][6])

因此，里程碑样本的共同点是：它们不是“最像地球”的行星，而是**最能把观测通道打开、把模型可检验化的行星**。

---

### 2.2 可居住带不是一句话：近邻与M矮星系统为何既诱人又困难
...
**Proxima Centauri b**之所以是近十年最重要的“近邻候选”之一，是因为它把这些困难集中到一个我们最近、最可能开展后续多波段监测的目标上：NASA目录页给出其基本轨道与质量尺度（约11.2天周期、质量约地球量级的量纲），这足以触发一整套关于潮汐演化、磁层防护、恒星风剥蚀与光化学的研究议程。([NASA Science][11])

与“单颗近邻”并行的是“多颗对照组”。**TRAPPIST-1**系统的科学价值并不只在于“有几颗位于可居住带附近”，而在于它提供了一个极罕见的实验设计：同一恒星、相近成分背景、不同辐照与潮汐条件下的一串近地大小岩质行星，且它们处在共振链结构中，方便用TTV（凌日计时变差）等方法对质量与内结构施加约束。NASA的TRAPPIST-1概览页把它作为系统级对象给出并引导到参考文献链条。([NASA Exoplanet Archive][9]) 更重要的是，JWST在这一系统上的策略已经从“幻想直接找地球2.0”转为“建立大气存在性的边界条件”：NASA在2025年的进展页明确表示，目前对其若干内侧行星尚未得到决定性的大气证据。([NASA Science][10]) 这其实是健康的科学过程：对于强辐照、强潮汐与可能的高能辐射环境，**“没有检测到大气”本身就是对形成与演化模型的强约束**，因为它把“保留大气的阈值条件”钉在了观测上。

**TOI-700 e**代表了TESS时代的另一条路线：从统计意义上更常见、观测上更可控的近邻M矮星可居住带小行星。JPL的发布强调它是可居住带内的地球尺寸世界，并且与同系统的另一颗地球尺寸行星构成非常适合做比较行星学的组合。([NASA Jet Propulsion Laboratory (JPL)][12]) 这类目标未来的关键，不是“立即证明宜居”，而是以透射谱/相位曲线/恒星高能谱监测，逐步回答：它们更像“裸岩石”、还是“薄大气岩质”、还是“被厚挥发物包裹的小海王星”。

---

### 2.3 “可能的生命信号”为什么最容易被误读：以K2-18 b为中心的理性框架

**K2-18 b**处在舆论与学术都高度聚焦的位置：一方面，它在可居住带内，且对大气透射谱相对友好；另一方面，它的尺度更接近“亚海王星/富挥发物世界”，未必有类地表面。NASA在2023年的JWST结果中强调，已在其大气中检测到甲烷与二氧化碳，并将其放在“后续进一步理解宜居性与组成”的语境里。([NASA Science][7])

2025年路透社报道把讨论推到“潜在生物信号”层面：JWST观测提示DMS/DMDS等分子信号，被描述为迄今最强的潜在生命证据之一，但报道同时强调需要重复观测与排除非生物来源。([Reuters][8]) 这里最重要的研究框架是把“分子检测”拆成三层命题，分别评估证据强度：
...
### 2.4 极端行星不是猎奇：它们在物理上提供“强迫项”，让模型可检验

很多“奇葩天气”的行星（黑得像煤、下铁雨、玻璃雨、被潮汐撕裂）在严肃研究里有共同用途：它们把某个物理过程的驱动力推到极端，使得信号更强、模型更容易被否证。

* **TrES-2 b**的极低反照率把“云/雾霾/吸收剂”问题尖锐化：当行星几乎不反光，任何关于气溶胶粒径分布、温度反演层、强吸收分子的解释都必须同时满足能量收支与相位曲线等约束。NASA把它称为“the planet of eternal night”，并以“比煤更不反光”作为其标识性特征。([NASA Science][16]) NatGeo对2011年Kepler测得极微弱反射信号的报道，也从观测难度侧面说明了该类测量为何能强力约束大气模型。([National Geographic][17])

* **WASP-76 b**的“铁雨”之所以重要，不在于文学性，而在于它把**三维环流 + 凝结云微物理 + 昼夜侧化学**耦合成可观测差异：UNIGE/PlanetS相关解读把它明确置于昼夜侧温差导致的凝结与输运图景中。([nccr-planets.ch][18]) 这类行星是检验GCM（全球环流模型）与高分辨率光谱反演能否一致的理想对象。

* **HD 189733 b**的“玻璃侧雨”来自高温下可能形成的硅酸盐颗粒与强风场的组合。NASA的科普图文虽然是面向公众，但其核心价值是把“风速数量级（超音速）+ 颗粒云”作为可表征目标的直观入口。([NASA][15]) 在研究端，它长期是相位曲线、温度分布反演与云参数化的基准样本之一。

* **WASP-12 b**把“潮汐相互作用”与“质量损失”推到可观测：2010年的Nature论文（及其arXiv版本）在摘要层面就明确讨论其被潮汐形变、并发生向母星的质量转移/损失的图景。([ui.adsabs.harvard.edu][19]) 这类系统的重要性在于，它让“行星轨道衰减、潮汐Q、行星结构耗散”从不可验证的长期演化，变成可通过凌日计时与长期监测触及的参数问题。

* **KELT-9 b**则是“超热木星”的极端端点：当平衡温度达到几千开，分子会解离、原子/离子谱线主导，传统的“类木星分子化学”需要整体重写。A&A论文把它称为已知最热的系外行星并给出量级温度指标，说明它在超热大气物理中的基准地位。([A&A][14])

结论是：极端行星的意义不是“离地球越远越好玩”，而是它们提供了大自然的“实验极限”，帮助我们在更短的观测时间里更强地约束模型。

---

### 2.5 从“结果”回到“起源”：直接成像与原行星系统为何是行星形成理论的关键证据链

如果说凌日与RV让我们擅长测“现在是什么”，那么**直接成像**与**原行星盘中的原行星**更接近在回答“它们怎么来的”。

**HR 8799**系统是多行星直接成像的里程碑：Science 2008的工作通过高对比成像直接看到多颗巨行星，之后又补全为四行星系统。([ui.adsabs.harvard.edu][21]) NASA的解读强调它在直接成像方法学与轨道动力学上的标杆意义。([NASA Science][22]) 这类系统用于检验：年轻巨行星的初始熵（热启动/冷启动）、云层导致的谱形退化、以及多行星在宽轨道下的长期稳定性。

而**PDS 70 b/c**把时间再往前推到“正在形成”：ApJ Letters 2021的摘要就指出该系统在盘的空隙中存在两颗原行星，并且通过Hα等证据指向仍在吸积、可能伴随环行星盘。([ui.adsabs.harvard.edu][23]) ALMA在2025年的新闻稿进一步强调其作为“行星增长的射电签名/环行星盘”研究对象的地位。([ALMA Observatory][24]) 这条证据链的意义在于：它把“盘内开隙—吸积—可能的卫星形成环境”连成一个可观测序列，让行星形成不再只是统计回归与数值模拟。


## 4) 关键反例与常见陷阱（你在写综述时最容易踩的坑）

* **“可居住带 = 宜居/有生命”**：在M矮星系统尤其不成立。正确写法应是“在给定假设下满足液态水辐照条件的候选”，并把恒星活动与潮汐锁定作为同等重要的条件约束（TRAPPIST-1与Proxima b正是用来研究这些约束的）。([NASA Science][10])
* **把“分子检出”直接写成“生命证据”**：K2-18 b的案例说明，最严谨的表述是“潜在生物信号候选，需要重复观测与排除非生物路径”。([Reuters][8])
* **忽视参数随时间更新**：尤其是质量、半径、平衡温度、反照率等，会随新数据与模型假设更新。综述里应明确“使用某目录/某论文版本的参数集”，并把“为何该参数对你的论证是鲁棒/不鲁棒”说清楚。
* **把科普叙事当作物理论断言**：例如“玻璃雨”“铁雨”是对凝结物与风场的形象化表达，论文层面讨论的是凝结曲线、昼夜输运与谱线约束。NASA/机构科普适合引入，但需要回到可检验的物理量与观测量。([NASA][15])


### 关键参考

* NASA：系外行星概览与已确认数量（>6000）([NASA Science][b2])
* NASA：Super-Earth 的常用质量范围与“成分多样性”提示([NASA Science][b6])
* 半径谷（1.5–2 $$R_\oplus$$）的观测与解释：A&A 2020、MNRAS 2019 等([aanda.org][b3])
* 亚海王星定义与族群综述：Seager 2021、Bean 2021([mdpi.com][b7])
* 热木星典型性质与周期量级：Fortney 2021（综述）与“周期<10天”的常用定义表述([agupubs.onlinelibrary.wiley.com][b5])
* IAU 工作定义（系外行星与氘燃烧上限）：综述论文([arxiv.org][b1])

[b1]: https://arxiv.org/pdf/2203.09520?utm_source=chatgpt.com "The IAU Working Definition of an Exoplanet"
[b2]: https://science.nasa.gov/exoplanets/?utm_source=chatgpt.com "Exoplanets"
[b3]: https://www.aanda.org/articles/aa/full_html/2020/11/aa39141-20/aa39141-20.html?utm_source=chatgpt.com "The nature of the radius valley - Hints from formation and ..."
[b4]: https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029%2F2020JE006639?utm_source=chatgpt.com "The Nature and Origins of Sub‐Neptune Size Planets - Bean"
[b5]: https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2020JE006629?utm_source=chatgpt.com "Hot Jupiters: Origins, Structure, Atmospheres - AGU Journals"
[b6]: https://science.nasa.gov/exoplanets/super-earth/?utm_source=chatgpt.com "What Is a Super-Earth?"
[b7]: https://www.mdpi.com/2218-1997/7/6/172?utm_source=chatgpt.com "Possibilities for an Aerial Biosphere in Temperate Sub ..."
[b8]: https://www.astro.yale.edu/jwang/Project5.html?utm_source=chatgpt.com "Hot Jupiters and Stellar Multiplicity"
[b9]: https://science.nasa.gov/resource/hot-jupiter/?utm_source=chatgpt.com "Hot Jupiter"
[b10]: https://www.britannica.com/science/rogue-planet?utm_source=chatgpt.com "Rogue planet | Definition, Examples, & Facts"
