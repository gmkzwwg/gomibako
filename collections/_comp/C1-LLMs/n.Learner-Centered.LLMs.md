...
学习范式的转变：
1. 目标导向的学习：定制学习路径，并且加入很多实操环节
2. 正常的学习之所以困难，是因为你需要记忆大量枯燥无味孤立的记忆项，然后从这个记忆项里边提取规律，依靠大脑的总结和联想能力获得直观的感受和方法。而我现在将使我直接获得直观的感受和方法。我没理由有了新工具，还只是加速老方法，而不是探索与之适配的新方法
